...
public class Adaptador extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<Video>> lstItensGrupos;
    private Context context;

    public Adaptador(Context context, List<String> grupos, HashMap<String, List<Video>> itensGrupos) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        Video produto = (Video) getChild(groupPosition, childPosition);
        tvItem.setText(produto.getAuthor());
        tvValor.setText(String.valueOf(produto.getDataCreated()));
